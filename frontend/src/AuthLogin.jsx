  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="bg-white shadow-sm border border-slate-100 rounded-xl p-6 w-full max-w-sm">
        ...
        <p className="text-xs text-slate-500 mb-4">Sign in with your provisioned account. Contact an admin to be added.</p>
        ...
        <div className="mt-4 text-xs text-slate-500 text-center">No account? Ask a system admin to provision one.</div>
      </div>
    </div>
  );
}
